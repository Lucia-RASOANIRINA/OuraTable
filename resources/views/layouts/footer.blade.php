                ...
                <form action="#" method="POST" class="flex flex-col gap-4">
                    ...
                    <div class="flex flex-col xl:flex-row gap-3">
                        <div class="relative flex-1 group/input">
                            ...
                            <input type="text" placeholder="Nom de la recette..." required class="w-full bg-gray-800/50 border border-white/5 rounded-2xl py-4 pl-12 pr-4 text-white text-sm focus:ring-2 focus:ring-orange-500 focus:bg-gray-800 transition-all duration-300 outline-none placeholder:text-gray-600 shadow-inner">
                        </div>
                        <div class="relative flex-1 group/input">
                            ...
                            <input type="email" placeholder="Votre email..." required class="w-full bg-gray-800/50 border border-white/5 rounded-2xl py-4 pl-12 pr-4 text-white text-sm focus:ring-2 focus:ring-orange-500 focus:bg-gray-800 transition-all duration-300 outline-none placeholder:text-gray-600 shadow-inner">
                        </div>
                    </div>
