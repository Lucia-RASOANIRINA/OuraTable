                    ...
                    <div class="absolute transition-all duration-700 ease-[cubic-bezier(0.23,1,0.32,1)]"
                        ...
                        <div class="relative group">
                            ...
                            <img src="{{ asset('storage/' . $recette->image_path) }}" 
                                class="carousel-image w-48 h-64 md:w-64 md:h-80 object-cover rounded-[2.5rem] shadow-2xl border-[10px] border-white transition-all duration-300 group-hover:scale-[1.03] group-hover:border-orange-400"
                                :class="currentIndex === {{ $index }} ? 'active' : ''"
                                @click="currentIndex === {{ $index }} ? openModal({{ $recette->id }}) : null">
                        </div>
                    </div>
                @endforeach
            @endif
        ...
        @foreach($recettes as $recette)
            ...
            <div class="relative bg-white rounded-[40px] shadow-sm border border-gray-100 flex overflow-hidden transition-all duration-500 hover:shadow-xl hover:-translate-y-1">
                ...
                <div class="relative w-2/5 min-w-[160px] flex items-center justify-center p-4 group">
                    ...
                    <div class="relative z-10 w-32 h-32 md:w-40 md:h-40 rounded-full overflow-hidden transition-transform duration-500 group-hover:scale-105 group-hover:rotate-2 cursor-pointer" onclick="openModal({{ $recette->id }})">
